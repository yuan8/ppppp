...
@section('body')
    <div class="login-box">
        <div class="login-logo text-center">
            <a class="" href="{{ url(config('adminlte.dashboard_url', 'home')) }}">{!! config('adminlte.logo', '<b>Admin</b>LTE') !!}</a>
            <div class="text-center">
            <img src="{{url(config('websetting.logo_tni'))}}" style="width: 20%">
                
            </div>
            <h3 class="text-center">{{config('websetting.name')}}</h3>
            <h5 class="text-center">{{config('websetting.sub_name')}}</h5>
